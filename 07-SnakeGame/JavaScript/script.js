...
function gameEngine() {
  ...
  if (isCollide(snakeArr)) {
    ...
    snakeArr = [{ x: 17, y: 9 }];
    score = 0;
    scoreBoard.innerHTML = "YourScore :" + score;
  }
  ...
  if (snakeArr[0].y === food.y && snakeArr[0].x === food.x) {
    ...
    //Score Update
    score += 1;
    //Update the HiScore In LocalStorage
